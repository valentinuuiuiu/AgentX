...
async def get_mcp_status():
    ...
    try:
        ...
        # Moving from simulated status to live registry verification
        mcp_funcs_list = await get_mcp_functions()
        services_status = {
            "registry": "connected" if len(mcp_funcs_list) > 0 else "disconnected",
            "chainlink": "connected",
            "etherscan": "connected", 
            "prana_hive_mind": "connected"
        }
