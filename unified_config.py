...
spec = importlib.util.spec_from_file_location("root_config", os.path.join(os.path.dirname(__file__), "app_config.py"))
...
class RehoboamConfig(BaseConfig):
    ...
    STRATEGIES = {
        ...
        "intelligent_arbitrage": {
            "enabled": True,
            "hive_mind_threshold": 0.7,
            "human_benefit_weight": 0.3,
            "weight": 0.6,
            "description": "HiveMind-guided arbitrage for human benefit"
        }
    }
