...
import { vetalaProtectionService } from '../services/hive_mind/vetalaProtectionService';
      ...
      {isLoading ? (
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-400 mt-2">Connecting to Vetala hive_mind...</p>
          </div>
        </div>
      ) : error ? (
        <div className="min-h-screen flex items-center justify-center">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-sm">
            {isConnected ? '🕉️ Connected to Divine HiveMind - AUTONOMOUS MODE ACTIVE' : '⚠️ Guardian Offline'}
          </span>
        </div>
