    ...
    try {
      ...
      if (providerName === 'MetaMask' && (window as any).ethereum) {
        ...
        if (!rawProvider.isMetaMask) {
          console.warn('MetaMask flag isMetaMask not found, but window.ethereum exists. Continuing connection...');
        }
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="text-5xl font-bold text-white mb-8">
                  {walletType === 'CEX' || !walletType ? '$0.00' : `${!isNaN(parseFloat(balance)) ? parseFloat(balance).toFixed(4) : '0.0000'} ETH`}
                </div>
