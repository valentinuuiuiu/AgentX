...
const TradingInterface: React.FC = () => {
  ...
  // Subscribe to live price updates via the DDD service
  useEffect(() => {
    container.priceService.start(SUPPORTED_PAIRS, setPriceData);
    return () => {
      container.priceService.stop(SUPPORTED_PAIRS);
    };
  }, []);
  ...
  if (historyError) {
    return <ErrorMessage error={historyError} />;
  }
