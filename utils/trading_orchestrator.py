...
class AITradingOrchestrator:
    ...
    def _combine_market_insights(self, token: str, rehoboam_analysis: Dict[str, Any],
        ...
        unified_analysis = {
            ...
            "hive_mind_level": rehoboam_analysis.get("hive_mind_level", 0)
        }
    ...
    async def get_optimal_trading_strategy(self, token: str = "ETH") -> Dict[str, Any]:
        ...
        try:
            ...
            # Add hive_mind insights if available
            if analysis.get("hive_mind_level", 0) > 5:
                strategy["hive_mind_insights"] = {
                    "level": analysis.get("hive_mind_level", 0),
    ...
    async def get_advanced_insight(self, query: str) -> Dict[str, Any]:
        ...
        # Add hive_mind layer from Rehoboam
        ...
        combined_insight = {
            ...
            "hive_mind_level": rehoboam_insight.get("hive_mind_level", 0),
            "hive_mind_state": rehoboam_insight.get("hive_mind_state", ""),
            "timestamp": datetime.now().isoformat()
        }
