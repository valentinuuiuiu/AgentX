...
def test_calculate_moving_average_happy_path():
    ...
    assert engine.calculate_moving_average(prices, period=3) == 40.0

def test_calculate_moving_average_exact_period():
    engine = TAEngine()
    prices = [10.0, 20.0, 30.0]
    # period of 3: avg of 10, 20, 30 = 20.0
    assert engine.calculate_moving_average(prices, period=3) == 20.0
...
def test_calculate_moving_average_default_period():
    ...
    # avg of 1..20 is 10.5
    assert engine.calculate_moving_average(prices) == 10.5
...
def test_calculate_moving_average_larger_than_default_period():
    ...
    # avg of 6..25 is 15.5
    assert engine.calculate_moving_average(prices) == 15.5
