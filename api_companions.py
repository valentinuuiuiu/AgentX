...
# Initialize the AI Companion Creator with enhanced hive_mind
# This will be initialized from the main API server's hive_mind layers
rehoboam = None
companion_creator = None

def initialize_companion_system(rehoboam_instance, companion_creator_instance):
    """Initialize the companion system with hive_mind layers from main API."""
    ...
    logger.info("Companion system initialized with Rehoboam hive_mind") # Original log kept for continuity
