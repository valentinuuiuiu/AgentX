...
class Config:
    ...
    USER_WALLET_ADDRESS = "0xYourWalletAddressHere" # Adresa portofelului MetaMask al utilizatorului
    USER_SOLANA_WALLET = "YourSolanaWalletAddressHere" # Adresa portofelului Solana al utilizatorului
    ...
    SUPPORTED_NETWORKS = [
        ...
        "polygon_zkevm",
        "scroll",
        "mina"  # Mina Protocol for zero-knowledge hive_mind expansion
    ]
    ...
    SUPPORTED_TOKENS = [
        ...
        "BAL",
        "CRV",
        "HAI",  # HackerAI token for Network hive_mind expansion
